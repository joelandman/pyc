...
| I-014 | **implement** as one late slice **or** leave accepted | Design is written. High-risk Codegen. Your call at approval (recommended: one slice at the end, abort if nbody/runner regress). |
