...
and nested `{0.attr}` / `{0[k]}` ([I-010](ISSUES.md)). `partition("")` /
`rpartition("")` raise `ValueError: empty separator`. Misses still print `None`
([I-041](ISSUES.md)); non-str sep is `ValueError` not `TypeError` ([I-040](ISSUES.md)).
