...
# Tue, 14 Jan 2025 12:05:45 GMT

#MAKE:
#mv nbody.python3-8.python3 nbody.py
#pyright .
#0 errors, 0 warnings, 0 informations 

#4.94s to complete and log all make actions
# COMMAND LINE:
# /opt/src/Python-3.13.0/bin/python3 -OO nbody.py 50000000
