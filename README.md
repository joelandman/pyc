...
the normal compiler path. **413/413 tests passing** (runner reports 413/413, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
