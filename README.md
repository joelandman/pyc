...
the normal compiler path. **242 strict-pass tests passing** (6 FILE_CASES are now strictly validated and currently fail — see `CORRECTNESS.md` and the runner for the diff).
