...
the normal compiler path. **220 strict-pass tests passing** (10 FILE_CASES are now strictly validated and currently fail — see `CORRECTNESS.md` #30-33 and the runner for the diff).
