...
the normal compiler path. **375/375 tests passing** (runner reports 375/375, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
