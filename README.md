...
the normal compiler path. **317/317 tests passing** (runner reports 317/317, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
