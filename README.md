...
the normal compiler path. **322/322 tests passing** (runner reports 322/322, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
