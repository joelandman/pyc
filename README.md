...
the normal compiler path. **436/436 tests passing** (runner reports 436/436, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
