...
the normal compiler path. **344/344 tests passing** (runner reports 344/344, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
