...
the normal compiler path. **417/417 tests passing** (runner reports 417/417, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
