...
the normal compiler path. **321/321 tests passing** (runner reports 321/321, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
