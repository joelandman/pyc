...
the normal compiler path. **433/433 tests passing** (runner reports 433/433, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
