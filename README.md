...
the normal compiler path. **315/315 tests passing** (runner reports 315/315, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
