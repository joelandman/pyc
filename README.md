...
the normal compiler path. **258 strict-pass tests passing** (runner reports 258/263; pre-existing unrelated DIFFs in nbody/hash/features; see `CORRECTNESS.md` and `tests/runner.py`).
