...
the normal compiler path. **367/367 tests passing** (runner reports 367/367, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
