...
the normal compiler path. **621/621 tests passing** (592 inline cases + 29 file cases, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
