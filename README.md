...
the normal compiler path. **254 strict-pass tests passing** (1 FILE_CASE is now strictly validated and currently fails — see `CORRECTNESS.md` and the runner for the diff).
