...
the normal compiler path. **323/323 tests passing** (runner reports 323/323, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
