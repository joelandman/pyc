...
the normal compiler path. **422/422 tests passing** (runner reports 422/422, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
