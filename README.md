...
the normal compiler path. **320/320 tests passing** (runner reports 320/320, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
