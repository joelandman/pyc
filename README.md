...
the normal compiler path. **622/622 tests passing** (593 inline cases + 29 file cases, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
