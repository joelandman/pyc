...
the normal compiler path. **358/358 tests passing** (runner reports 358/358, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
