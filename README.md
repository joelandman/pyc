...
the normal compiler path. **340/340 tests passing** (runner reports 340/340, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
