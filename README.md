...
the normal compiler path. **311/311 tests passing** (runner reports 311/311, file_case_failures=0; every case compared against CPython output; see `tests/runner.py`).
