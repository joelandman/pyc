...
the normal compiler path. **249 strict-pass tests passing** (2 FILE_CASES are now strictly validated and currently fail — see `CORRECTNESS.md` and the runner for the diff).
