...
enum class IRInstKind { ALLOC, STORE, LOAD, PHI, LOADGLOBAL, STOREGLOBAL, LOADLOCAL, STORELOCAL,
    ...
    NEWTYPE, MAKE_LIST, MAKE_DICT, MAKE_TUPLE, LIST_GET, LIST_SET, DICT_GET, DICT_SET, NEWOBJ, ISINSTANCE,
    ADD, SUB, MUL, DIV, MOD, POW, LT, LE, GT, GE, EQ, NE, AND, OR, NOT, IN, IS,
    JUMP, BRANCH, LABEL, INTRINSIC_PRINT, INTRINSIC_RANGE, INTRINSIC_TYPE, INTRINSIC_LEN,
    INTRINSIC_INIT, LOAD_ATTR, SLICE_GET, BUILD_STRING };
